...
require_once "urledit_class.php";
require_once "auth_class.php";
require_once "section_class.php";

class ManageEdit extends Manage {
	...
	public function auth() {
		...
		if ($auth->checkEdit($_SESSION["login"], $_SESSION["password"])) return $this->data["r"];
	...
	public function addDiscount() {
		...
		if ($this->discount->add($temp_data)) {
			...
			return $this->url_edit->discounts();
		}
		else return false;
	}
