...
<p class="link_new">
	<a href="<?=$this->link_new?>">Добавить новое задание</a>
</p>
<table class="info">
	<tr class="header">
		<td align="center">№</td>
	...
	<?php foreach ($this->table_data as $data) { ?>
		<tr>
			...
			<td>
				<a href="<?=$data["link_edit_edit"]?>">Редактировать</a>
				<br />
				<a href="<?=$data["link_edit_delete"]?>" onclick="return confirm('Вы уверены, что хотите удалить элемент?')">Удалить</a>
			</td>
		</tr>
	<?php } ?>
</table>
